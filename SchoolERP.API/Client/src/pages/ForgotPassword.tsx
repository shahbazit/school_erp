...
import { GraduationCap, Home, Mail, ArrowLeft } from 'lucide-react';
          ...
          {submitted ? (
            <div className="text-center animate-in fade-in duration-500">
              ...
              <p className="text-sm text-slate-500 mb-8 leading-relaxed">
                If an account exists for <span className="font-bold text-slate-700">{email}</span>, you will receive a password reset link shortly.
              </p>
              <Link
                to="/login"
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center pt-2">
                  <Link to="/login" className="inline-flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-primary-600 transition-colors">
